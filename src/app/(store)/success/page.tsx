...
function SuccessPage() {
  ...
  return (
    <div className="flex flec-col items-center justify-center min-h-screen bg-gray-50 ">
      <div className="bg-white p-12 rounded-xl shadow-lg max-w-2xl w-full mx-4">
        ...
        <div className="border-t border-b border-gray-200 py-6 mb-6 flex flex-col items-center justify-center">
